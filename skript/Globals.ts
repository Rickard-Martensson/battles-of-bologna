...
const STATS = {
    soldier: {
        ...
        animations: { [SpriteCurAnim.idle]: new SpriteAnimation(32, 0, 8, 60, true), [SpriteCurAnim.walk]: new SpriteAnimation(32, 1, 8, 19.1804, true), [SpriteCurAnim.attack]: new SpriteAnimation(32, 2, 7, 20, false) }
    },
    archer: {
    ...
    veteran: {
        ...
        animations: { [SpriteCurAnim.idle]: new SpriteAnimation(32, 0, 8, 60, true), [SpriteCurAnim.walk]: new SpriteAnimation(32, 1, 8, 19.1804, true), [SpriteCurAnim.attack]: new SpriteAnimation(32, 2, 12, 18, false) }
    },
    ballista: {
        ...
        animations: { [SpriteCurAnim.idle]: new SpriteAnimation(32, 0, 8, 60, true), [SpriteCurAnim.walk]: new SpriteAnimation(32, 1, 8, 19.1804, true), [SpriteCurAnim.attack]: new SpriteAnimation(32, 2, 8, 18, false) }
    },
    sprinter: {
    ...
    viking: {
        hp: 90, dmg: 4, meleRange: 12, range: 0, atkSpeed: 1200, atkDelay: 500, speed: 6,
        abilities: [], row: 0, img: "viking_img", imageSize: 32, size: 7,
    ...
    spearman: {
        hp: 80, dmg: 2, meleDmg: 4, meleRange: 12, range: 2.5, atkSpeed: 2000, atkDelay: 750, speed: 6,
        abilities: ["spear", "meleClose"], row: 0, img: "spearman_img", imageSize: 32, size: 7,
        animations: { [SpriteCurAnim.idle]: new SpriteAnimation(32, 0, 8, 60, true), [SpriteCurAnim.walk]: new SpriteAnimation(32, 1, 8, 19.1804, true), [SpriteCurAnim.attack]: new SpriteAnimation(32, 3, 8, 18, false), [SpriteCurAnim.special]: new SpriteAnimation(32, 2, 9, 22, false) }
    },
    brute: {
        hp: 12, dmg: 3, meleRange: 12, range: 0, atkSpeed: 1200, atkDelay: 500, speed: 6,
