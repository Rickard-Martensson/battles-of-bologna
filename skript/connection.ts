    ...
    message: function (event) {
        ...
        // }
            ...
            if (uuid != event.message.sender) {
                ...
                if (content.mySide != -1) { }
                else if (content.mySide == 0) { mySide = 1 }
                else { mySide = 0 }
            ...
            let sprites: Sprite[] = content.sprites;
            let projectiles: Projectile[] = content.projectiles;
            let buyQueue: any[] = content.buyQueue;
